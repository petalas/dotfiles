...
plugins=(brew git node nvm yarn zsh-autosuggestions zsh-syntax-highlighting)
...
alias ll="ls -lah"
alias youtube-dl-best="youtube-dl -f '(bestvideo+bestaudio/best)' --merge-output-format 'mkv'"
alias sshzeus="ssh nick@192.168.1.104"

# work - genesis
alias sshdeveep1="ssh -i /Users/nick/projects/genesis/ssh/id_rsa genesis@10.40.3.137"
alias sshdevbton1="ssh -i /Users/nick/projects/genesis/ssh/id_rsa genesis@10.40.3.146"
