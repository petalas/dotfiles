...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/vim-be-good",
