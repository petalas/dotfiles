...
- Linux setup uses process-scoped systemd idle/sleep inhibition and, when a GNOME session is available, GNOME idle/suspend inhibition. Locks are released automatically when setup exits.
