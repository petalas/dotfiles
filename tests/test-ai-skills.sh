...
--yes	skills	add	https://github.com/petalas/skills.git	--skill	adversarial-review	architect	arena	auditable-run	automate-me	blast-radius	bro	commit-guidelines	configure-agent-models	create-verification-skill	engineering-mode	explain-code	how	maintain-verification-skill	power-of-ten	principle-boundary-discipline	principle-build-the-lever	principle-encode-lessons-in-structure	principle-exhaust-the-design-space	principle-experience-first	principle-fix-root-causes	principle-foundational-thinking	principle-guard-the-context-window	principle-laziness-protocol	principle-local-autonomy	principle-make-operations-idempotent	principle-minimize-reader-load	principle-model-domain-in-code	principle-outcome-oriented-execution	principle-prove-it-works	principle-redesign-from-first-principles	principle-replace-internal-apis-atomically	principle-separate-before-serializing-shared-state	principle-sequence-verifiable-units	principle-subtract-before-you-add	principle-type-system-discipline	recall	reflect	regression-test	review-code-comments	safe-refactor	show-me-your-work	swarm	technical-writing	typescript-best-practices	unslop	why	worktree-cleanup	--global${expected_agent_fields}
EOF
