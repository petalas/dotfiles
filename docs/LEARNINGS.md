...
- The canonical dark SeaShells palette is pinned to [`odysseyalive/omarchy-seashells-theme@00dca31`](https://github.com/odysseyalive/omarchy-seashells-theme/blob/00dca31761374d5526790dd8a10271edbc6f9ec8/omarchy/themes/seashells/colors.toml). Palette changes must update Ghostty, Kitty, Pi, OMP, the Powerlevel10k literal-color allowlist, and the generated Terminal profile together; `tests/test-seashells-palette.sh` guards that contract. Shell and Powerlevel10k numeric mappings use ANSI indexes and do not need remapping when slot colors change.
